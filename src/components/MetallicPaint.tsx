...
uniform float u_distort,u_contour,u_matte;
...
void main(){
  ...
  float brushed=pW(vec3(sc.x*7.,sc.y*180.,u_seed*.13)).x;
  vec3 matteCol=mix(vec3(lum),col,.78)+brushed*.018;
  col=mix(col,clamp(matteCol,0.,1.),u_matte);
