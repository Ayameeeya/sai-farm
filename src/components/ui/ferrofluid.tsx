...
// React Bits の Ferrofluid 背景 (https://www.reactbits.dev/backgrounds/ferrofluid)
// を ogl ベースで移植したもの。流体のリムが揺らめく WebGL 背景。
// 透過キャンバスとして任意の背景の上に重ねられる。
...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
  ...
  // ogl の canvas は premultipliedAlpha: false のため、
  // 色はそのまま・強度はアルファに乗せて straight alpha で出力する
